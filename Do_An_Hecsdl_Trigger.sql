...
GO
GRANT SELECT ON XUAT_NV to Managers
GRANT SELECT ON XUAT_NV_CHUCVU to Managers
GRANT SELECT ON XUAT_KH to Managers
GRANT SELECT ON XUAT_VL to Managers
GRANT SELECT ON XUAT_NCC to Managers
GRANT SELECT ON XUAT_CVIEC to Managers
GRANT SELECT ON XUAT_CHUCVU to Managers
...
GRANT EXEC ON THEM_CHUCVU to Managers
...
GRANT EXEC ON XOA_CHUCVU to Managers
...
GRANT EXEC ON SUA_CHUCVU to Managers
GRANT EXEC ON SUA_USERS to Managers
GRANT EXEC ON SUA_NHAPKHO to Managers
GO
GRANT SELECT ON TIMKIEM_CHITIET_HD to Managers
...
GO
GRANT SELECT ON XUAT_NV to Members
GRANT SELECT ON XUAT_NV_CHUCVU to Members
GRANT SELECT ON XUAT_KH to Members
GRANT SELECT ON XUAT_VL to Members
GRANT SELECT ON XUAT_NCC to Members
GRANT SELECT ON XUAT_CVIEC to Members
GRANT SELECT ON XUAT_CHUCVU to Members
...
---GRANT EXEC ON SUA_DONG to 
GRANT EXEC ON SUA_NHAPKHO to Members
GO
GRANT SELECT ON TIMKIEM_CHITIET_HD to Members
